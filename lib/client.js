...
class FormletClient {
  ...
  create(namespace, formlet, payload, _createdBy) {
    ...
    return this.dispatch('entry.create', payload).then((r) => r.result);
  }
  ...
  update(namespace, id, payload, _updatedBy) {
    ...
    return this.dispatch('entry.update', payload).then((r) => r.result);
  }
  ...
  read(namespace, formlet, id, filter) {
    ...
    return this.dispatch('entry.read', payload).then((r) => r.result);
  }
  ...
  find(namespace, formlet, filter) {
    ...
    return this.dispatch('entry.find', payload).then((res) => {
      return {
        result: res.result,
        meta: res.meta
      };
  ...
  delete(namespace, id, filter, _deletedBy) {
    ...
    return this.dispatch('entry.delete', payload).then((r) => true);
  }
  ...
  namespace(ns) {
    ...
    let wrapper = {
      create: this.create.bind(this, ns),
      read: this.read.bind(this, ns),
      update: this.update.bind(this, ns),
      delete: this.delete.bind(this, ns),
      find: this.find.bind(this, ns),
      history: this.history.bind(this, ns)
    };
    return wrapper;
  }
